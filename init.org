...
** =gptel=
#+begin_src emacs-lisp :tangle "post-init.el" :mkdirp yes
  (use-package auth-source :ensure t)
  ...
  (use-package gptel
    ...
    (setq
     ...
     gptel-backend (gptel-make-azure "Azure-1"
                     ...
                     :endpoint "/openai/deployments/gpt-4o-mini/chat/completions?api-version=2025-01-01-preview"
                     :stream t
                     :key #'gptel-api-key
                     :models '(gpt-4o-mini)))
    ;; (setq gptel-model  'gpt-4o
    ;;       gptel-api-key (get-password-from-authinfo "api.github.com" "m-e-shum") ;(getenv "GITHUB_TOKEN")
    ;;       gptel-backend
  ...
  (use-package org
    ...
    (setq org-startup-indented t ;; auto aligns text with header
          ...
          org-todo-keywords '((sequence "TODO(t)" "IN-PROGRESS(i)" "|" "DONE(d)")
                              (sequence "|" "QUEUED(q)" "WAITING(w)" "CANCELLED(c)"))
          ))
