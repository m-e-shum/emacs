...
#+begin_src emacs-lisp :tangle "post-init.el" :mkdirp yes
  ;; Tree-Sitter
  ;; Emacs 30 does NOT need python-ts-mode, etc.
  ;; If you want to check if ts mode is running, describe variable
  ;;   tree-sitter-mode, tree-sitter-hl-mode should be true
  ;;   (I think it turns on font-lock-mode too)
  ;; (require 'tree-sitter)
