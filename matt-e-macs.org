...
#+begin_src emacs-lisp :tangle "matt-e-macs-modules/matt-e-macs-my-org.el" :mkdirp yes
    (use-package org
      ...
      :mode (("\\.org$" . org-mode))
      :preface
      (defun my-directories-exist-p (directories)
        "Return a list of directories that exist from the given list DIRECTORIES."
      ...
      (setq org-startup-indented t ;; auto aligns text with header
            ...
            org-directory (expand-file-name (my-directories-exist-p '("/da/dmp/cb/shumma1/notes/2024/"
                                                                      "~/notes/2024")))
